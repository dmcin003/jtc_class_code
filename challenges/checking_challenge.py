...
my_checking = CheckingAccount('Darron',1669)
my_checking.deposit(1500)
my_checking.withdraw(4000)
...
# Currently, if you pass non int or float values, the methods 'deposit'
# and 'withdraw' will error out
