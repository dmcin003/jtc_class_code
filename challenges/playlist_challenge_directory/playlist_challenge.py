...
'''
song1 = {'artist':"Tamia",'title':"So into You"}
...
print('Question 5')
song2 = {'artist':"Drake",'title':"Laugh Now Cry Later"}
song3 = {'artist':"J Cole",'title':"Lion King on Ice"}
...
mean_of_monthly_plays = np.mean(monthly_plays)
print(mean_of_monthly_plays)
