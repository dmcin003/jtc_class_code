...
for airport in borough['airports']:
	print(airport['name'])
...
if "parks" in borough:
	print("This borough has beautiful parks!")
else:
	print("Sorry! This borough does not have parks.")
...
for borough in nyc:
	print(borough['name'])
	print()
	if 'beaches' in borough:
		for beach in borough['beaches']:
			print(f'\t{beach["name"]}')
	else:
		print("\tNo beaches in this borough.")
	if 'parks' in borough:
		for park in borough['parks']:
			print(f'\t{park["name"]}')
	else:
		print("\tNo parks in this borough.")		
...
for borough in nyc:
	print(borough['name'])
	print()
	if places_input.lower() in borough:
		for places in borough[places_input.lower()]:
			print(f'\t{places["name"]}')
	else:
		print(f'\tThere is no {places_input} in this borough.')
